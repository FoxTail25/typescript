...
// интерфейс можно сделать не только для объекта, но и для функции. Для этого в теле интерфейса указывается "сингатура вызова функции": Параметры для функции и их типы, а так же тип возвращаемого объекта.
...
//=======================================================================================
// "фрагментарное"(частичное) использование интерфейса. в свойствах интерфейса, мы можем хранить как сингатуры функций, так и типы.
//=======================================================================================
interface IFuncZ {
    stringArr: string[];
}

let arr: IFuncZ["stringArr"] = ['a', 'b']

//=======================================================================================
// Интерфейс задания индекса для массивов, объектов и др.
// В typeScript можно задавать тип данных для индекса.
// Индерксируемые тип для массивов.
...
let arrTyp: IArrStr = ['a', 'b', 'c'];
// console.log(typeof arrTyp) // object
// console.log('it`s arr ' + Array.isArray(arrTyp)) //true
...
let arrType2: IArrNum = [1, 2, 3]
// console.log(typeof arrType2) // object
// console.log('it`s arr ' + Array.isArray(arrType2)) //true
console.dir(arrType2) //true
//=============================================================================
// Индерксируемые тип для объектов.
// В объектах в качестве ключа используется строчное значение string
// Создадим интерфейс для объекта (в качестве значения поставим тип any, что бы можно было хранить любой тип данных)
interface IObject {
    [index: string]: any;
}
...
let obj: IObject = {
    a: "abc",
    b: 2,
    c: (n: number): number => n ** 2,
    d: (s: number): string => s.toString()
}
...
interface IObjectArr {
    [index: number]: string;
}
let objArr: IObjectArr = {
    1: 'a',
    2: 'b',
    3: 'c',
}
