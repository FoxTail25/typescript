...
let map: Map<string, number | string> = new Map(); // подобной записью мы ограничиваем тип ключа string, а тип значения number или строка.
map.set('строка1', 1);
map.set('строка2', 2);
console.log(map)
console.log(map)
...
let set: Set<string | number[]> = new Set();// Теперь в нашей уникальной коллекции могут храниться либо строки, либо числовые массивы.
set.add('a')
set.add([1, 2, 3])
console.log(set)
